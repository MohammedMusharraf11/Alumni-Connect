    ...
    <div className="flex">
      <div className="fixed top-0 left-0 w-64 min-h-screen bg-white border-r font-outfit">
        ...
        <ul className="text-[#2B64BB] mt-5">
          <li className={`flex items-center gap-3 py-3.5 px-3 md:px-9 cursor-pointer ${
          ...
          <button
            className="flex items-center gap-3 py-3.5 px-3 md:px-9 text-red-500 cursor-pointer"
