...
function Features() {
  ...
  return (
    <div className="container mx-auto py-16 font-outfit" data-aos="fade-right" data-aos-duration="700">
      ...
      <div className="text-center mt-8">
        <button onClick={()=>navigate('/roleselection')} className= "bg-primary text-white font-light py-2 px-6 rounded-full shadow-lg hover:bg-orange-600 transition font-outfit">Join Now</button>
      </div>
    </div>
  );
}
