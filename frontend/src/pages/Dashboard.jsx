...
//import Messages from "../components/messages/Messages.jsx"; // Assuming this was imported correctly.
...
function Dashboard() {
  ...
  const renderContent = () => {
    console.log("Active Section:", activeSection); // Debugging to ensure section is being set
    ...
    switch (activeSection) {
      ...
      case "open-source":
        return <OpenSource />;
      case "messages":
        return <div>kya karun main iska bc </div>; // Replace this with the correct import
      default:
      ...
      <div className="col-span-2 flex justify-center px-4 pt-4">
        <div className="relative flex flex-col items-center">
          <button onClick={toggleDropdown} className="flex items-center space-x-2 focus:outline-none">
            <span className="font-outfit font-bold text-secondary">{loggedInUser}</span>
            <img src={assets.Profile} alt="Profile" className="w-10 h-10 rounded-xl" />
          </button>
          {isDropdownOpen && (
